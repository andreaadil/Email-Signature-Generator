...
app.post("/generate", function(req, res) {
  ...
  if (brand === "Beauty-Thru-Nature") {
    ...
    linkedInIcon = "https://drive.google.com/uc?export=view&id=1TqHXX5sNMbgZesZ5uJXUAIlzC2Wq4G_2";
  }
  ...
  res.render("generate", {name: name, title: title, mNumber: mNumber, image: image, colour: colour, landline: landline, domain: domain, feature1: feature1, feature2: feature2, url1: url1, url2: url2, facebookURL: facebookURL, instagramURL: instagramURL, linkedInURL: linkedInURL, mapsURL: mapsURL, linkedInIcon: linkedInIcon});
})
